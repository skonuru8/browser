...
class BlockLayout:
    ...
    #API compatibility: new_line and self_rect
    def new_line(self) -> None:
        """
        Start a new line of inline content. In this implementation, a new line
        is equivalent to flushing the current line.
        """
        self.flush()

    def self_rect(self) -> 'Rect':
        """
        Return the bounding rectangle of this block. Note that width and height may not
...
class InputLayout:
    ...
    rectangle and the element’s value or label.
    """
    def __init__(self, node, parent, previous):
        self.node = node
        self.parent = parent
